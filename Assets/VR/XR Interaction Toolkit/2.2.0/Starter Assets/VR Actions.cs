...
//     version 1.5.0
//     from Assets/VR/XR Interaction Toolkit/2.2.0/Starter Assets/VR Actions.inputactions
//
...
public partial class @VRActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""eb50b29f-3503-4de8-b53c-7ed715192461"",
    ...
    public struct XRIHeadActions
    {
        ...
        public XRIHeadActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRILeftHandActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRILeftHandInteractionActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRILeftHandLocomotionActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRIRightHandActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRIRightHandInteractionActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRIRightHandLocomotionActions(@VRActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @VRActions m_Wrapper;
        public XRIUIActions(@VRActions wrapper) { m_Wrapper = wrapper; }
